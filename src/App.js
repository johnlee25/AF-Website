  ...
  constructor(props) {
    ...
    this.state = {
      ...
      pastEvents: [
        ...
        { eventName: "2019 First General Meeting", eventUrl: "2019-First-General-Meeting", eventDate: "September 29, 2019", eventIcon: whyIsDayTradingSoHard, eventContent: "Thank you everyone for coming to McMaster Asian FOCUS's first general meeting, it was such as blast! We hope you all enjoyed our Minute to Win it games and won some amazing prizes! Also, a special thanks Szechuan Noodle Bowl, Beijing Hut, and Sapporo for providing everyone with their delicious dishes and another thank you COCO Fresh Tea and TeaFun for providing us with bubble tea! Here are the long awaited photos, hope to see you all again soon!", eventIndex: 11 },
        { eventName: "First Asian Night: RAID", eventUrl: "First-Asian-Night-RAID", eventDate: "October 9 2019", eventIcon: whyIsDayTradingSoHard, eventContent: "Hey guys! Thank you again for coming to RAID, our first Asian Night 🙂 Here are the all the photos!", eventIndex: 12 },
        ...
        { eventName: "2020 Second General Meeting", eventUrl: "2020-Second-General-Meeting", eventDate: "January 27, 2020", eventIcon: whyIsDayTradingSoHard, eventContent: "Happy Lunar new year everyone! Thank you all for coming to the 2nd the last Asian FOCUS general meeting of the year! We had such a great turn out and hopefully it was a lot of fun for all of you!A special thank you to Szechuan Noodle Bowl, Coco Fresh Tea, Beijing Hut and Sakura Tea for all the delicious food and drinks! Stay tuned for our upcoming events by following our fb and ig page @mcmasterasianfocus, and see you all very soon!", eventIndex: 14 }
