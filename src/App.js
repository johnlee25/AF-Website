  ...
  constructor(props) {
    ...
    this.state = {
      ...
      storeItems: [
        ...
        { itemName: "Asian Focus Hoodie", itemPicture: whyIsDayTradingSoHard, itemGender: "Male", itemPrice: "50", itemIndex: 1 },
        { itemName: "Yes im out of ideas", itemPicture: whyIsDayTradingSoHard, itemGender: "Male", itemPrice: "50", itemIndex: 2 },
        { itemName: "Me", itemPicture: whyIsDayTradingSoHard, itemGender: "Male", itemPrice: "50", itemIndex: 3 },
        { itemName: "Stick", itemPicture: whyIsDayTradingSoHard, itemGender: "Male", itemPrice: "50", itemIndex: 4 },
        { itemName: "Milk Tea", itemPicture: whyIsDayTradingSoHard, itemGender: "Female", itemPrice: "50", itemIndex: 5 },
        { itemName: "Bubble Tea", itemPicture: whyIsDayTradingSoHard, itemGender: "Female", itemPrice: "50", itemIndex: 6 },
        { itemName: "Asian Focus Bottle Opener", itemPicture: whyIsDayTradingSoHard, itemGender: "Female", itemPrice: "50", itemIndex: 7 },
        { itemName: "Tears", itemPicture: whyIsDayTradingSoHard, itemGender: "Female", itemPrice: "50", itemIndex: 8 },
        { itemName: "John Lee Picture Card", itemPicture: whyIsDayTradingSoHard, itemGender: "Female", itemPrice: "50", itemIndex: 9 },
        { itemName: "Asian Focus Cup", itemPicture: whyIsDayTradingSoHard, itemGender: "Female", itemPrice: "50", itemIndex: 10 }
      ],
      ...
      <Router>
        ...
        <Switch>
          ...
          {this.state.storeItems.map(
            ({ itemIndex, key }) =>
              <Route path={"/shop/" + itemIndex} exact render={(props) => <ShopPage  {...props} storeItems={this.state.storeItems[itemIndex - 1]} />} />
          )}
          <Route path="/events" exact render={(props) => <Upcoming  {...props} upcomingEvents={this.state.upcomingEvents} />} />
